...
const mapTwoToThe = (arr) => {
  let squares = arr.map(i => Math.pow(2, i));
      return squares;
};
...
//found conditional operator on https://stackoverflow.com/a/1771824
//not sure why i wouldn't work but x did.
/* ------------------------------------------------------------------------------------------------
CHALLENGE 6
